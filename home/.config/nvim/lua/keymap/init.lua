...
local plug_map = {
	...
	-- And `1gt` to jump to 1st tabpage
	["n|1gb"] = map_cr("BufferLineGoToBuffer 1"):with_noremap():with_silent(),
	["n|2gb"] = map_cr("BufferLineGoToBuffer 2"):with_noremap():with_silent(),
	["n|3gb"] = map_cr("BufferLineGoToBuffer 3"):with_noremap():with_silent(),
	["n|4gb"] = map_cr("BufferLineGoToBuffer 4"):with_noremap():with_silent(),
	["n|5gb"] = map_cr("BufferLineGoToBuffer 5"):with_noremap():with_silent(),
	["n|6gb"] = map_cr("BufferLineGoToBuffer 5"):with_noremap():with_silent(),
	...
	["n|<C-t>"] = map_cr("LSoutlineToggle"):with_noremap():with_silent(),
	...
	["t|<C-=>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),
	["n|<A-f>"] = map_cr([[execute v:count . "ToggleTerm direction=float"]]):with_noremap():with_silent(),
	["i|<A-f>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=float<CR>"):with_noremap():with_silent(),
	["t|<A-f>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),

	["n|<leader>t"] = map_cr("lua toggle_lazygit()"):with_noremap():with_silent(),
	["t|<leader>t"] = map_cmd("<Esc><Cmd>lua toggle_lazygit()<CR>"):with_noremap():with_silent(),
